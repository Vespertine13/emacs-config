...
#+begin_src emacs-lisp
  ...
  (setq my-init-modules '("Dashboard" "Keybinding" "Experimental" "Emojis" "Pandoc" "Themes" "Python" "R" "Agenda" "Zettelkasten" "Teos" "Packages" "Constants" "Elfeed" "Windows_specific"))
