...
#+begin_src emacs-lisp
  ...
  (defun load-module-and-measure-time (module file)
	...
	(if (> elapsed-time 0)
      ...
      (setq loaded-modules ())
      ;; Loading modules
      (load-module-and-measure-time "Constants" "~/Dropbox/config/constants.org")
      (load-module-and-measure-time "Packages" "~/emacs-config/mod/packages.org")
      (load-module-and-measure-time "Teos" "~/Dropbox/config/teos.org")
      ...
      (load-module-and-measure-time "Emojis" "~/Dropbox/config/emojis.org")
      (load-module-and-measure-time "Elfeed" "~/Dropbox/config/elfeed.org")
      ...
      (load-module-and-measure-time "Experimental" "~/Dropbox/config/experimental.org")
...
#+begin_src emacs-lisp
  ...
  ;; Set the banner
  (setq dashboard-startup-banner "~/Dropbox/emacs_startup.txt")
  ;; Value can be
