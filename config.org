...
;; other
;; abbrev defs 
(setq FILE_ABBREV (concat FOLDER_CLOUD "config/abbrev_defs"))
;; bell sound for timer
(setq WAV_BELL (concat FOLDER_CLOUD "bell.wav"))
;; today's date
(setq TXT_DATE (concat FOLDER_CLOUD "temp/today.txt"))
;; timeliste
...
#+begin_src emacs-lisp
  ...
  (defun load-module-and-measure-time (module file)
	...
	(if (> elapsed-time 0)
      ...
      (setq my-init-modules '("Keybinding" "Functions" "EMMS" "Abbrev" "Mastodon" "Pandoc" "Themes" "Python" "R" "Company" "Agenda" "Zettelkasten" "Packages"))
