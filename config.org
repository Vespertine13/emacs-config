...
#+end_src
** Load from cloud
Constants and experimental loads from cloud
#+begin_src emacs-lisp
  (ignore-errors (load-file (concat FOLDER_CLOUD "config/constants.el")))
  (ignore-errors (load-file (concat FOLDER_CLOUD "config/experimental.el")))
#+end_src
** Loading Modules
#+begin_src emacs-lisp
  ...
  (defun load-module-and-measure-time (module file)
	...
	(if (> elapsed-time 0)
      ...
      (setq my-init-modules '("Keybinding" "Functions" "EMMS" "Abbrev" "Mastodon" "Emojis" "Pandoc" "Themes" "Python" "R" "Company" "Agenda" "Zettelkasten" "Packages"))
