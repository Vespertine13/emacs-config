...
#+begin_src emacs-lisp
  ...
  (when (not (boundp 'my-init-modules))
    (setq my-init-modules '("packages" "agenda" "undo-tree" "org-styling" "zettelkasten" "flyspell" "company" "R" "python" "emms" "abbrev" "paste-fix" "mastodon" "elfeed" "consult" "keybinding")))
