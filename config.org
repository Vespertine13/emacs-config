...
#+begin_src emacs-lisp
  ...
  (defun load-module-and-measure-time (module file)
	...
	(if (> elapsed-time 0)
      ...
      (setq my-init-modules '("Keybinding" "Experimental" "Functions" "ERC" "Mastodon" "Elfeed" "Emojis" "Pandoc" "Themes" "Python" "R" "Company" "Agenda" "Zettelkasten" "Teos" "Packages" "Constants"))
