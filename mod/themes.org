...
#+begin_src emacs-lisp
  ...
  (defun select-theme (theme)
    (interactive (list (completing-read "Theme: " my-theme-list)))
    (unless (member theme my-theme-list)
  ...
  (defun cycle-themes ()
    ...
    (interactive)
    (setq current-theme-idx (mod (1+ current-theme-idx) 8))
    (cond ((= current-theme-idx 0) (set-theme 'base16-greenscreen))
      ...
      ((= current-theme-idx 6) (set-theme 'misterioso))
      ((= current-theme-idx 7) (set-theme 'bharadwaj-slate))))
#+end_src
* Day/Night Themes
#+begin_src emacs-lisp
