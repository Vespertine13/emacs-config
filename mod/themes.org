...
#+begin_src emacs-lisp
  (defun set-hourly-theme ()
    ...
    (cond
     ;; Morning
     ((and (>= current-hour 6) (< current-hour 12)) (set-theme 'subtle-blue))
     ;; Afternoon
     ((and (>= current-hour 12) (< current-hour 18)) (set-theme 'silkworm))
     ;; Evening
     ((>= current-hour 18) (set-theme 'birds-of-paradise-plus))
     ;; Night
