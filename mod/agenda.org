...
#+begin_src emacs-lisp
  ...
  (unless (file-exists-p "~/.emacs.d/today.txt")
    (create-empty-file "~/.emacs.d/today.txt"))
  (when (not (file-content-equal-to-string "~/.emacs.d/today.txt" today-var))
    (replace-file-contents "~/.emacs.d/today.txt" today-var)
