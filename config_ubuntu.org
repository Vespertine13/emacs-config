...
;; Enable EMMS browser mode
(require 'emms-browser)

;; Define keybindings (customize as needed)
...
;; Change the path to your music directory
(setq emms-source-file-default-directory "~/mega/music/")
#+end_src
** ERC Support
#+begin_src emacs-lisp
  ;; erc-tls autorun
